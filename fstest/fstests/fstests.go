...
func Run(t *testing.T, opt *Opt) {
	...
	t.Run("FsMkdir", func(t *testing.T) {
		...
		t.Run("FsMkdirMetadata", func(t *testing.T) {
			...
			fstest.CheckDirMetadata(ctx, t, f, dir, testMetadata)
			fstest.CheckDirMetadata(ctx, t, f, fstest.NewDirectory(ctx, t, f, name), testMetadata)
			...
			t.Run("Update", func(t *testing.T) {
				...
				// Check the returned directory and one read from the listing
				fstest.CheckDirMetadata(ctx, t, f, dir, testMetadata2)
				fstest.CheckDirMetadata(ctx, t, f, fstest.NewDirectory(ctx, t, f, name), testMetadata2)
			})
		...
		t.Run("FsDirectory", func(t *testing.T) {
			...
			t.Run("ReadDirMetadata", func(t *testing.T) {
				...
				fstest.CheckDirMetadata(ctx, t, f, dir, fs.Metadata{
